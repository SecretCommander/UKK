...
<head>
  ...
  <title>Data Gambar | User Database</title>
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            <li class="nav-item menu-open">
              ...
              <?php if($see) {?>
                ...
                <?php }?>
                <li class="nav-item">
                  <a href="Gambar-datalist.php" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Gambar Datalist</p>
                  </a>
                </li>
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Gambar Datalist</li>
              </ol>
            </div>
            <!-- /.col -->
          </div>
                ...
                <table id="example1" class="table table-hover text-nowrap table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        <td><?= $i ?></td>
                        <td><img src="../../../album/<?= $row["lokasi_file"] ?>" alt=""></td>
                        <td><?= $row["judul_foto"] ?></td>
                        <td><textarea cols="30" rows="5" disabled><?= $row["deskripsi_foto"] ?></textarea></td>
                        <td><?= $row["username"] ?></td>
                        <td>
                          <a role="button" class="btn bg-info" href="gambar.php?gambar=<?= $row['fotoid'] ?>">Komentar</i></a>
                          <a href="#" class="btn bg-gradient-danger" onclick="showAlert(<?= $row['fotoid'] ?>)">
      ...
      swalWithBootstrapButtons
        ...
        .then((result) => {
          if (result.isConfirmed) {
            window.location.href = "delete_gambar.php?id=" + idp;
          } else if (
