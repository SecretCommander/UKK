...
<head>
    ...
    <title>Memorize | Pencarian</title>
</head>
...
<body>
    ...
    <nav class="navbar navigasi navbar-expand-lg">
        <div class="container-fluid d-flex flex-nowrap">
            ...
            <div class="d-flex justify-content-center align-items-center flex-grow-1 atas">
                <form class="d-flex ukur" role="search" method="POST">
                    <input class="form-control mr-2 cari" type="search" placeholder="Cari Gambar" aria-label="Search" id="search" name="search" value="<?= $key ?>">
    ...
    <div class="mt-5">
        <footer class="text-center text-lg-start" style="background-color: #DC3535;">
            ...
            <?php } ?>
            <!-- Copyright -->
            <div class="text-center text-white p-3" style="<?php echo empty($_SESSION['id_user']) ? "background-color: rgba(0, 0, 0, 0.2);" : "background-color: #DC3535;" ?>">
                Copyright©:
